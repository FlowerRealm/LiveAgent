...
pub const PROVIDER_API_KEY_UPDATES_FIELD: &str = "providerApiKeyUpdates";
pub const PROVIDER_USAGE_QUERY_SECRET_UPDATES_FIELD: &str = "providerUsageQuerySecretUpdates";
pub const SYSTEM_PROXY_PASSWORD_UPDATE_FIELD: &str = "systemProxyPasswordUpdate";
pub const SSH_SECRET_UPDATES_FIELD: &str = "sshSecretUpdates";
pub const SSH_PATCH_FIELD: &str = "sshPatch";
