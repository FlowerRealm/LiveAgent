pub fn load_gateway_settings_sync_snapshot(conn: &Connection) -> Result<Value, String> {
...
pub fn redact_gateway_settings_sync_payload(payload: Value) -> Result<Value, String> {
